                ...
                <div className="history">
                    ...
                    <div className='history__itens'>
                        <div className='history__iten'>
                            <img src={require("../../images/gas.png")} alt="itens" className='histori__img' />
                            <h1>National Gas $150</h1>
                        </div>
                        <div className='history__iten'>
                            <img src={require("../../images/insurance.png")} alt="itens" className='histori__img' />
                            <h1>Safest Security $150</h1>

                        </div>
                        <div className='history__iten'>
                            <img src={require("../../images/mortgage.png")} alt="itens" className='histori__img' />
                            <h1>House Deposit $150</h1>

                        </div>
                        <div className='history__iten'>
                            <img src={require("../../images/eletricity.png")} alt="itens" className='histori__img' />
